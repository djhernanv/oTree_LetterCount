...
class Player(BasePlayer):
    ...
    st1 = models.PositiveIntegerField()
    st2 = models.PositiveIntegerField()
    st3 = models.PositiveIntegerField()
    st4 = models.PositiveIntegerField()
    st5 = models.PositiveIntegerField()
    st6 = models.PositiveIntegerField()
    st7 = models.PositiveIntegerField()
    st8 = models.PositiveIntegerField()
